...
class CapitalT(object):
    ...
    def clone(self):
        ...
        #     clone.pdf.
        # --------------------------------------------------------------
        bob = CapitalT(self.h_rect.get_center(), self.h_rect.get_width(), self.v_rect.get_height(), self.v_rect.get_width())
        bob.v_rect.fill_color = self.v_rect.fill_color
        bob.h_rect.fill_color = self.h_rect.fill_color
        bob.v_rect.outline_color = self.v_rect.outline_color
        bob.h_rect.outline_color = self.h_rect.outline_color
        return bob

...
class Line(object):
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        nstart = self.start.plus(other_line.start)
        nend = self.end.plus(other_line.end)
        return Line(nstart, nend)
    ...
    def line_minus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        nstart = self.start.minus(other_line.start)
        nend = self.end.minus(other_line.end)
        return Line(nstart, nend)
